...
import { User, Mail, Shield, Key, Save, Loader } from "lucide-react";

export default function Profile() {
    const { user, setUser } = useAuth(); // Assume setUser is added to context to update global state
    ...
    // NUCLEAR FIX: Base URL for local testing
